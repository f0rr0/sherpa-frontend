    ...
    switch(action.type){
        case types.USER_UPDATE:
            return Object.assign({}, state, {
                ...
                usedMap:            action.userData.usedMap || state.usedMap,
                usedEditTrip:       action.userData.usedEditTrip || state.usedEditTrip,
                ...
                scrapeState:        action.userData.scrapeState || state.scrapeState,
